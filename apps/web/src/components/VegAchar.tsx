    ...
    const fetchVegAcharProducts = async () => {
      try {
        ...
        if (data.success && data.data.products) {
          // Filter for veg achar products (you can adjust this filter based on your data structure)
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Discover our delicious collection of vegetarian pickles made with
            fresh vegetables and traditional spices
          </p>
        </motion.div>
            ...
            {products.map((product, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <button className="w-full bg-green-600 text-white py-3 rounded-lg hover:bg-green-700 transition-colors duration-200 flex items-center justify-center space-x-2">
