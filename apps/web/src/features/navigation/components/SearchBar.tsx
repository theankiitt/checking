      ...
      <form onSubmit={handleSubmit}>
        <div className="relative">
          ...
          <input
            ...
            className={`w-full pl-10 pr-10 py-3 border border-gray-200 rounded-xl  focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent bg-white text-black text-md sm:text-lg placeholder-gray-900 placeholder:font-medium ${inputClassName}`}
